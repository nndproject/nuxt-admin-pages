...
<template>
   <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
    ...
    <div>
      <MenuButton class="inline-flex w-full justify-center px-3 py-2 text-sm font-semibold text-gray-300  hover:text-white rounded-md px-3 py-2">
        Options
        <ChevronDownIcon class="-mr-1 h-5 w-5 text-gray-300  hover:text-white " aria-hidden="true" />
      </MenuButton>
    </div>
